...
const LoginPage = () => {
  useEffect(() => {
    ...
    const handleOAuthLogin = async () => {
      ...
      const authUrl = `https://accounts.google.com/o/oauth2/auth?client_id=${CLIENT_ID}&redirect_uri=https://generate-bill.vercel.app/upload&scope=${encodeURIComponent(SCOPES)}&response_type=token`;
